(function () {
    ...
    function getPrinterSettings() {
        ...
        const paperWidth = Number(site.printerPaperWidth || 80);
        const contentWidth = Number(site.printerContentWidth || (paperWidth === 58 ? 50 : 72));
        const scale = Number(site.printerScale || 0.9);
